...
func (c *urlShortenerClient) ShortenURL(ctx context.Context, in *URLRequest, opts ...grpc.CallOption) (*URLResponse, error) {
	out := new(URLResponse)
	err := c.cc.Invoke(ctx, "/short.UrlShortener/ShortenURL", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *urlShortenerClient) GetOriginalURL(ctx context.Context, in *URLRequest, opts ...grpc.CallOption) (*URLResponse, error) {
	out := new(URLResponse)
	err := c.cc.Invoke(ctx, "/short.UrlShortener/GetOriginalURL", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUrlShortenerServer) GetOriginalURL(context.Context, *URLRequest) (*URLResponse, error) {
...
func _UrlShortener_ShortenURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/short.UrlShortener/ShortenURL",
	}
...
func _UrlShortener_GetOriginalURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/short.UrlShortener/GetOriginalURL",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UrlShortenerServer).GetOriginalURL(ctx, req.(*URLRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UrlShortener_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "short.UrlShortener",
